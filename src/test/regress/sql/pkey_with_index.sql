...
ALTER TABLE rpi_test DROP CONSTRAINT rpi_test_pkey,
	ADD CONSTRAINT rpi_replaced_pkey PRIMARY KEY(b, a)
		WITH (INDEX = 'rpi_uniq2_idx');
...
ALTER TABLE rpi_test ADD PRIMARY KEY(b, a)
	WITH (INDEX = 'rpi_idx_doesnt_exist');
...
ALTER TABLE rpi_test ADD PRIMARY KEY (a, b)
	WITH ( INDEX = 'rpi_idx2', INDEX = 'rpi_idx2' );
...
-- should fail
ALTER TABLE rpi_test DROP CONSTRAINT rpi_test_pkey, ADD PRIMARY KEY(a, b)
	WITH (INDEX = 'rpi_idx3');
